...
handler.command = /^(anticolong|d|colong)$/i
handler.premium = true
export default handler

async function addExif(buffer, packname, author, categories = [''], extra = {}) {
	const img = new Image()
	const json = { 'sticker-pack-id': 'dimss_senpai', 'sticker-pack-name': `Punya`, 'sticker-pack-publisher': `Dims-Senpai`, 'emojis': categories, 'is-avatar-sticker': 1, ...extra }
