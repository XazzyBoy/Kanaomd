...
if (!text) throw `Contoh penggunaan ${usedPrefix + command} tensei shitara ken deshita`
await m.reply(wait)
...
handler.help = ['anibatch', 'animeindo', 'drivenime', 'anikyoji', 'animeplanet', 'anoboy', 'fanfox', 'gogoanime', 'kissmanga', 'klikmanga', 'komiku', 'mangadex', 'manganato']
handler.command = ['anibatch', 'animeindo', 'drivenime', 'animeplanet', 'anoboy', 'fanfox', 'gogoanime', 'kissmanga', 'klikmanga', 'komiku', 'mangadex', 'manganato']
handler.tags = ['searching']

export default handler

// Kalo mau ngambil kasih nama gw di tqto:)
