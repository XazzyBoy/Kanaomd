...
console.log(e)
try {
let data = await fetch(`https://api.azz.biz.id/api/play?q=${args[0]}&key=global`)
let res = await data.json()
await conn.sendFile(m.chat, res.mp4, 'anu.mp4', res.videoInfo.title, m)
} catch {
console.log(e)
try {
conn.sendMessage(m.chat, { video: { url: `https://aemt.me/youtube?url=${args[0]-}?filter=videoonly&quality=highestvideo&contenttype=video/mp4` }, caption: `Ini kak sudah di download >,<` },{ quoted: m })
