...
global.mods = ['6281398274790', '6285607265790'] // Developer / Mods Number
...
// Sistem
global.wait = '_Sedang di proses mohon tunggu..._'
...
- btchx ( Dapatkan di https://api.botcahx.live/ )
- lol ( Dapatkan di https://api.lolhuman.xyz/ )
- xzn ( Dapatkan di https://skizo.tech/ )
- ibeng ( Dapatkan di https://api.ibeng.tech/ )
- fg ( Dapatkan di https://api-fgmods.ddns.net )
- zenz ( Dapatkan di https://api.zahwazein.xyz/ )
- imgbb ( Dapatkan di https://api.imgbb.com/ )

Use example = .addapi lol Your_Key
*/
global.lolkey = 'Your_key'
global.xznkey = 'Your_key'
global.zenzkey = 'Your_key'
...
global.APIKeys = { 
  ...
  'https://api.zahwazein.xyz/': zenzkey,
  'https://api.ibeng.tech/': ibeng,
  'https://api.botcahx.live/': btc,
